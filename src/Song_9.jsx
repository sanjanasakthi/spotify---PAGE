...
import for_logo from './assets/image/dandelions.jpg'
import './App.css';
 import useSound from 'use-sound';
import onSound from './assets/audio/Dandelions.mp3'
    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                    ...
                    <div className='row'>
                       ...
                       <b className='text-white'>Dandelions</b>
                       </div>
                ...
                <div className='row'>
                    <div className='col-sm-3'></div>
                    <div className='col-sm-5'>
                        <p className='text-white'>Dandelions</p>
                        <p className='text-muted'>Ruth B</p>
                     </div>
                ...
                <Link  to='/home_8' onClick={()=> stop()} className="bi bi-caret-left-fill text-white btn set_size"></Link>
