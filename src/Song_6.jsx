...
import for_logo from './assets/image/dark.jpg'
import './App.css';
 import useSound from 'use-sound';
import onSound from './assets/audio/DARKSIDE.mp3';
    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                    ...
                    <div className='row'>
                       ...
                       <b className='text-white'>Dark_side</b>
                       </div>
                ...
                <div className='row'>
                    <div className='col-sm-3'></div>
                    <div className='col-sm-5'>
                        <p className='text-white'>Dark_side</p>
                        <p className='text-muted'>Neonnie</p>
                     </div>
                ...
                <Link  to='/home_5' onClick={()=> stop()} className="bi bi-caret-left-fill text-white btn set_size"></Link>
                ...
                ></button>
                <Link to='/home_7' onClick={()=> stop()}  className="bi bi-caret-right-fill text-white btn set_size " ></Link>
