...
import for_logo from './assets/image/perfect.jpg'
import './App.css';
 import useSound from 'use-sound';
import onSound from './assets/audio/Perfect.mp3';
    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                    ...
                    <div className='row'>
                       ...
                       <b className='text-white'>Perfect</b>
                       </div>
                ...
                <div className='row'>
                    ...
                    <div className='col-sm-5'>
                        ...
                        <p className='text-muted'>Ed-Sheeran</p>
                     </div>
                ...
                <Link  to='/home_6' onClick={()=> stop()} className="bi bi-caret-left-fill text-white btn set_size"></Link>
                ...
                ></button>
                <Link to='/home_8' onClick={()=> stop()}  className="bi bi-caret-right-fill text-white btn set_size " ></Link>
