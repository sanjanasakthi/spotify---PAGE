...
import for_logo from './assets/image/left_right.jpg'
import './App.css';
 import useSound from 'use-sound';
import onSound from './assets/audio/Left.mp3';
    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                    ...
                    <div className='row'>
                       ...
                       <b className='text-white'>Left & Right</b>
                       </div>
                ...
                <div className='row'>
                    <div className='col-sm-3'></div>
                    <div className='col-sm-5'>
                        <p className='text-white'>Left And Right</p>
                        <p className='text-muted'>Charlie Puth & Jung Kook</p>
                     </div>
                ...
                <Link  to='/home_9' onClick={()=> stop()} className="bi bi-caret-left-fill text-white btn set_size"></Link>
                ...
                ></button>
                <Link to='/home_11' onClick={()=> stop()}  className="bi bi-caret-right-fill text-white btn set_size " ></Link>
