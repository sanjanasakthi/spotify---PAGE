...
import for_logo from './assets/image/thousand_years.jpg'
import './App.css';
 import useSound from 'use-sound';
import onSound from './assets/audio/A_Thousand_Years.mp3';
    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                    ...
                    <div className='row'>
                       ...
                       <b className='text-white'>A Thousand Years</b>
                       </div>
                ...
                <div className='row'>
                    <div className='col-sm-3'></div>
                    <div className='col-sm-5'>
                        <p className='text-white'>A Thousand Years</p>
                        <p className='text-muted'>Christian Perri</p>
                     </div>
                ...
                <Link to='/home_3' onClick={()=> stop()}  className="bi bi-caret-left-fill text-white btn set_size"></Link>
                ...
                ></button>
                <Link  to='/home_5' onClick={()=> stop()} className="bi bi-caret-right-fill text-white btn set_size " ></Link>
