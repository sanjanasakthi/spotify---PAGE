    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                ...
                <div className='row'>
                    <div className='col-sm-3'></div>
                    <div className='col-sm-5'>
                        <p className='text-white'>BTS 마약</p>
                ...
                <Link  to='/home_10' onClick={()=> stop()} className="bi bi-caret-left-fill text-white btn set_size"></Link>
                ...
                ></button>
                <Link to='/home' onClick={()=> stop()}  className="bi bi-caret-right-fill text-white btn set_size " ></Link>
