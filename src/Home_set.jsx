...
import for_logo from './assets/image/logo.jpg'
import './App.css';
 import useSound from 'use-sound';
import onSound from './assets/audio/BTS - Run.mp3';
    ...
    return(
              <div className='container mt-5 border border-5 w-100 h-100 set_color'>
                    ...
                    <div className='row'>
                       ...
                       <b className='text-white'>Run BTS 달리다</b>
                       </div>
                ...
                <div className='row'>
                    <div className='col-sm-3'></div>
                    <div className='col-sm-5'>
                        <p className='text-white'>Run BTS</p>
                        <p className='text-muted'>RM, JIN, SUGA, JHOPE, JIMIN, V & JK</p>
                     </div>
                ...
                <Link to='/home_11' onClick={()=> stop()} className="bi bi-caret-left-fill text-white btn set_size"></Link>
                ...
                ></button>
                <Link to='/home_2'onClick={()=> stop()} className="bi bi-caret-right-fill text-white btn set_size " ></Link>
